...
export function resolveName (name: string, prefix: string, contractAddress: string = "juno1qr76sfjnr40xulzlymm2ehx5wxwv8pyqnlah5smqtnfrq446guvs42xc6l", rpc: string = "https://rpc.uni.junomint.com:443/"): Promise<string> {
