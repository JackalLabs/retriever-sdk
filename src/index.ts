...
export function resolveName (name: string, prefix: string, contractAddress: string = "juno1qr76sfjnr40xulzlymm2ehx5wxwv8pyqnlah5smqtnfrq446guvs42xc6l"): Promise<string> {
